...
#### Okay, things get a little more interpratable with the meadow plots excluded.
...
dbWriteTable(conn, SQL('"nr_misc"."vibi_forest_group_syntbl_percfreq_sorted"'), vibi.forest.syntbl.percfreq.sorted$syntable, overwrite = TRUE, row.names = FALSE)
```
...
dbWriteTable(conn, SQL('"nr_misc"."vibi_forest_group_syntbl_meanabund_sorted"'), vibi.forest.syntbl.meanabund.sorted$syntable, overwrite = TRUE, row.names = FALSE)
```
