...
```{r ,include=TRUE, eval=FALSE}
vibi.forest.grp.constancy <- const(vibi.forest.rare.removed, vibi.combined.new.forest.kmeans6.cluster$kmeans6.forest.cluster)
```

```{r ,include=FALSE, eval=FALSE}
write.csv(vibi.forest.grp.constancy, file="vibi_forest_group_constancy_10102024.csv")
```

#### Build species abundance table
```{r ,include=TRUE, eval=FALSE}
vibi.forest.grp.abundance <- importance(vibi.forest.rare.removed, vibi.combined.new.forest.kmeans6.cluster$kmeans6.forest.cluster)
```

```{r ,include=FALSE, eval=FALSE}
write.csv(vibi.forest.grp.abundance, file="vibi_forest_group_abundance_10102024.csv")
```
