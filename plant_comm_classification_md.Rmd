...
```{r ,include=TRUE, eval=FALSE}
vibi.forest.syntbl.meanabund <- syntable(vibi.forest.rare.removed, vibi.combined.new.forest.kmeans6.cluster$kmeans6.forest.cluster, abund = "percentage", type = "mean", digits = 3)
```
