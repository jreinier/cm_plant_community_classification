...
```{r ,include=TRUE, eval=FALSE}
vibi.forest.syn.tbl.percfreq <- syntable(vibi.forest.rare.removed, vibi.combined.new.forest.kmeans6.cluster$kmeans6.forest.cluster, abund = "percentage", type = "percfreq")
```

```{r ,include=FALSE, eval=FALSE}
write.csv(vibi.forest.syn.tbl.percfreq$syntable, file="vibi_forest_group_synoptic_percfreq_10162024.csv")
```

```{r ,include=TRUE, eval=FALSE}
vibi.forest.syn.tbl.phi <- syntable(vibi.forest.rare.removed, vibi.combined.new.forest.kmeans6.cluster$kmeans6.forest.cluster, abund = "percentage", type = "phi")
```

```{r ,include=FALSE, eval=FALSE}
write.csv(vibi.forest.syn.tbl.phi$syntable, file="vibi_forest_group_synoptic_phi_10162024.csv")
```
