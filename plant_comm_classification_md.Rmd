...
kable(vibi.forest.syntbl.trees.sorted, digits = 4, row.names = FALSE, align = "c",
              caption = NULL, col.names = c("Species code", "Sugar Maple - Mixed Hardwood", "Bottomland", "Oak - Mixed Hardwood", "Ruderal", "Wet-Mesic Red Maple", "Beech - Mixed Hardwood")) %>%
  kable_classic (html_font = "Cambria") %>%
  column_spec(2, background = ifelse(vibi.forest.syntbl.trees.sorted$species_code %in% vibi.forest.syntbl.trees.sorted$species_code[1:8], "gray", "white")) %>%
  column_spec(3, background = ifelse(vibi.forest.syntbl.trees.sorted$species_code %in% vibi.forest.syntbl.trees.sorted$species_code[9:15], "gray", "white")) %>%
  column_spec(4, background = ifelse(vibi.forest.syntbl.trees.sorted$species_code %in% vibi.forest.syntbl.trees.sorted$species_code[16:23], "gray", "white")) %>%
  column_spec(5, background = ifelse(vibi.forest.syntbl.trees.sorted$species_code %in% vibi.forest.syntbl.trees.sorted$species_code[24:26], "gray", "white")) %>%
  column_spec(6, background = ifelse(vibi.forest.syntbl.trees.sorted$species_code %in% vibi.forest.syntbl.trees.sorted$species_code[27:32], "gray", "white")) %>%
  column_spec(7, background = ifelse(vibi.forest.syntbl.trees.sorted$species_code %in% vibi.forest.syntbl.trees.sorted$species_code[33:34], "gray", "white"))
```
...
kable(vibi.forest.syntbl.smtrees.sorted, digits = 4, row.names = FALSE, align = "c",
  ...
  column_spec(4, background = ifelse(vibi.forest.syntbl.smtrees.sorted$species_code %in% vibi.forest.syntbl.smtrees.sorted$species_code[2:3], "gray", "white")) %>%
  column_spec(7, background = ifelse(vibi.forest.syntbl.smtrees.sorted$species_code %in% vibi.forest.syntbl.smtrees.sorted$species_code[4], "gray", "white"))
```
...
kable(vibi.forest.syntbl.shrubs.sorted, digits = 4, row.names = FALSE, align = "c",
              caption = NULL, col.names = c("Species code", "Sugar Maple - Mixed Hardwood", "Bottomland", "Oak - Mixed Hardwood", "Ruderal", "Wet-Mesic Red Maple", "Beech - Mixed Hardwood")) %>%
  kable_classic (html_font = "Cambria") %>%
  column_spec(2, background = ifelse(vibi.forest.syntbl.shrubs.sorted$species_code %in% vibi.forest.syntbl.shrubs.sorted$species_code[1:4], "gray", "white")) %>%
  column_spec(4, background = ifelse(vibi.forest.syntbl.shrubs.sorted$species_code %in% vibi.forest.syntbl.shrubs.sorted$species_code[5], "gray", "white")) %>%
  column_spec(5, background = ifelse(vibi.forest.syntbl.shrubs.sorted$species_code %in% vibi.forest.syntbl.shrubs.sorted$species_code[6:12], "gray", "white")) %>%
  column_spec(6, background = ifelse(vibi.forest.syntbl.shrubs.sorted$species_code %in% vibi.forest.syntbl.shrubs.sorted$species_code[13:14], "gray", "white")) %>%
  column_spec(7, background = ifelse(vibi.forest.syntbl.shrubs.sorted$species_code %in% vibi.forest.syntbl.shrubs.sorted$species_code[15], "gray", "white"))
```
...
kable(vibi.forest.syntbl.vines.sorted, digits = 4, row.names = FALSE, align = "c",
              caption = NULL, col.names = c("Species code", "Sugar Maple - Mixed Hardwood", "Bottomland", "Oak - Mixed Hardwood", "Ruderal", "Wet-Mesic Red Maple", "Beech - Mixed Hardwood")) %>%
  kable_classic (html_font = "Cambria") %>%
  column_spec(2, background = ifelse(vibi.forest.syntbl.vines.sorted$species_code %in% vibi.forest.syntbl.vines.sorted$species_code[1:2], "gray", "white")) %>%
  column_spec(3, background = ifelse(vibi.forest.syntbl.vines.sorted$species_code %in% vibi.forest.syntbl.vines.sorted$species_code[3], "gray", "white")) %>%
  column_spec(4, background = ifelse(vibi.forest.syntbl.vines.sorted$species_code %in% vibi.forest.syntbl.vines.sorted$species_code[4], "gray", "white")) %>%
  column_spec(5, background = ifelse(vibi.forest.syntbl.vines.sorted$species_code %in% vibi.forest.syntbl.vines.sorted$species_code[5:6], "gray", "white"))
```
...
kable(vibi.forest.syntbl.herbs.sorted, digits = 4, row.names = FALSE, align = "c",
              caption = NULL, col.names = c("Species code", "Sugar Maple - Mixed Hardwood", "Bottomland", "Oak - Mixed Hardwood", "Ruderal", "Wet-Mesic Red Maple", "Beech - Mixed Hardwood")) %>%
  kable_classic (html_font = "Cambria") %>%
  column_spec(2, background = ifelse(vibi.forest.syntbl.herbs.sorted$species_code %in% vibi.forest.syntbl.herbs.sorted$species_code[1:22], "gray", "white")) %>%
  column_spec(3, background = ifelse(vibi.forest.syntbl.herbs.sorted$species_code %in% vibi.forest.syntbl.herbs.sorted$species_code[23:48], "gray", "white")) %>%
  column_spec(4, background = ifelse(vibi.forest.syntbl.herbs.sorted$species_code %in% vibi.forest.syntbl.herbs.sorted$species_code[49:54], "gray", "white")) %>%
  column_spec(5, background = ifelse(vibi.forest.syntbl.herbs.sorted$species_code %in% vibi.forest.syntbl.herbs.sorted$species_code[55:74], "gray", "white")) %>%
  column_spec(6, background = ifelse(vibi.forest.syntbl.herbs.sorted$species_code %in% vibi.forest.syntbl.herbs.sorted$species_code[75:86], "gray", "white")) %>%
  column_spec(7, background = ifelse(vibi.forest.syntbl.herbs.sorted$species_code %in% vibi.forest.syntbl.herbs.sorted$species_code[87:101], "gray", "white"))
```
